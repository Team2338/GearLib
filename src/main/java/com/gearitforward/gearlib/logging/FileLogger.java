...
//		"/home/lvuser/logs", // Local dir on roborio
	 ...
	 *
	 * @param filenamePrefix A prefix for the name of the file.
	 ...
	 */
	protected FileLogger(String filenamePrefix, String[] directories, DoubleSupplier timeSupplier) {
		this.directories = directories;
		this.fw = createLogWriter(filenamePrefix, directories);
		this.timeSupplier = timeSupplier;
	}
	
	protected FileWriter createLogWriter(String filePrefix, String[] directories) {
	...
	public void init() {
		initTime = timeSupplier.getAsDouble();
	}
